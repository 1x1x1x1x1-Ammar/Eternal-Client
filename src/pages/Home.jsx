...
export default function Home() {
  ...
  return <motion.div className="release-home beta6-home beta8-home premium-home" variants={stagger} initial="hidden" animate="show">
    <motion.section className="release-hero beta6-hero beta8-hero premium-hero" variants={rise}>
      ...
      <motion.div className="release-hero-copy premium-hero-copy" initial={{ opacity: 0, x: -14 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: .34 }}>
        <div className="premium-kicker-row"><span className="release-kicker">ETERNAL CLIENT · v{appVersion || '0.8.0-beta.8'}</span><span className="premium-live-pill"><i/>BETA 8</span></div>
